...
export const loadProductCatalog = cache(async (): Promise<ProductType[]> => PRODUCT_CATALOG);

export async function getCategories(): Promise<string[]> {
  return [...new Set(PRODUCT_CATALOG.map((product) => product.category))];
}

export function getProductById(productId: string): ProductType | undefined {
